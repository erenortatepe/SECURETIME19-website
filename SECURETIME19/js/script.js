...
// Overlay button event listener
if (overlayBtn) {
  overlayBtn.addEventListener('click', swapper, false);
}
  



const openBtn2 = document.querySelector("[data-open2]");
const closeBtn2 = document.querySelector("[data-close2]");
...
// Overlay button event listener
if (overlayBtn2) {
  overlayBtn2.addEventListener('click', swapper, false);
}


const openBtn3 = document.querySelector("[data-open3]");
const closeBtn3 = document.querySelector("[data-close3]");
...
// Overlay button event listener
if (overlayBtn3) {
  overlayBtn3.addEventListener('click', swapper, false);
}



const openBtn4 = document.querySelector("[data-open4]");
const closeBtn4 = document.querySelector("[data-close4]");
...
// Overlay button event listener
if (overlayBtn4) {
  overlayBtn4.addEventListener('click', swapper, false);
}




const openBtn5 = document.querySelector("[data-open5]");
const closeBtn5 = document.querySelector("[data-close5]");
...
// Overlay button event listener
if (overlayBtn5) {
  overlayBtn5.addEventListener('click', swapper, false);
}


const openBtn6 = document.querySelector("[data-open6]");
const closeBtn6 = document.querySelector("[data-close6]");
...
// Overlay button event listener
if (overlayBtn6) {
  overlayBtn6.addEventListener('click', swapper, false);
}
...
function topFunction() {
  // Yavaşça yukarı kaydırma (smooth scrolling) için JavaScript kullanma
  // Yeni tarayıcılarda destekleniyor, ancak eski tarayıcılarda çalışmayabilir
...
(function () {
	var options = {
		whatsapp: "+905405190019",
		call_to_action: "Bizimle iletişim kurun!",
		position: "left",
	};
	...
	s.async = true;
	s.src = url + '/widget-send-button/js/init.js'; // '/' eklendi
	s.onload = function () { WhWidgetSendButton.init(host, proto, options); };
	var x = document.getElementsByTagName('script')[0]; // '=' eklendi
